...
<body>
  <div class="login-form">
    <form action="" method="POST" autocomplete="off">
      <h2 class="text-center">Mokumbu</h2>
      <p class="hint-text">Tela de Login</p>
    ...
    <p class="text-center">Não tens uma conta?<a href="register.php" class="text-danger"> Cadastrar-se</a></p>
  </div>
</body>
